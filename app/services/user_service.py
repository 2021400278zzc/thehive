...
class UserService:
    ...
    def update_user(user_id, data):
        ...
        if 'mbti' in data: user.mbti = data['mbti']
        if 'star_sign' in data: user.star_sign = data['star_sign']
        if 'skills' in data: user.skills = data['skills']
        if 'interests' in data: user.interests = data['interests']
        if 'year_of_study' in data: user.year_of_study = data['year_of_study']
        if 'major' in data: user.major = data['major']
        if 'picture' in data: user.picture = data['picture']
        if 'best_working_experience' in data: user.best_working_experience = data['best_working_experience']

        if 'key_factors' in data: user.set_key_factors(data['key_factors'])
        if 'lightning_answers' in data: user.set_lightning_answers(data['lightning_answers'])
        if 'fun_facts' in data: user.set_fun_facts(data['fun_facts'])
        if 'tags' in data: user.set_tags(data['tags'])
